<?php 
	...
	$pass = "uscitp2022";
	$db = "maxmcgra_small_countries_db";
	...
	//Perform SQL Queries
	$sql_countries = "SELECT DISTINCT `Country/Territory` from smallcountries;";
	$sql_continents = "SELECT DISTINCT continent FROM smallcountries;";
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<h1 class="col-12 mt-4">Small Countries <strong>popFinder</strong></h1>
